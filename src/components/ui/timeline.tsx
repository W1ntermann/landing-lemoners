    ...
    return (
        ...
        >
            ...
            <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
                {data.map((item, index) => (
                    ...
                    >
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            ...
                            <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-neutral-500 dark:text-neutral-500 text-center w-full">
                                {item.title}
                            </h3>
                        </div>
                ...
                {/* Фіксована висота лінії - обмежуємо її висотою контенту */}
                <div
                    style={{
                        height: height + "px",
                    }}
